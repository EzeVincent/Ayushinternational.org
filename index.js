...
window.onload = function() {
  ...
  var words = ["Advanced Industrial Coding Machines.", "DOD Printers.", "Character Inkjet Printers.", "Laserjet Printers.", "Thermal Transfer Overlay.", "Handheld Printers.", "Hologram 3D.", "Belt Conveyors.", "Air Compressors.", "ForkLifts."]; // Add your words here
  var index = 0;
...
window.addEventListener("scroll", () => {
  if(window.scrollY > section3El.offsetTop - navbarEl.offsetHeight - 60)
    {
